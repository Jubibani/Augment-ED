...
import com.google.ar.core.examples.kotlin.helloar.HelloArRenderer.Companion
import com.google.ar.core.examples.kotlin.helloar.R
import com.google.ar.core.examples.kotlin.libraryscan.WrappedAnchor
...
class LibraryScanRenderer(val activity: LibraryScanActivity) :
    ...
    //bacteria
    lateinit var bacteriaMesh: Mesh
    lateinit var bacteriaShader: Shader
    lateinit var bacteriaAlbedoTexture: Texture
    lateinit var bacteriaTexture : Texture
    lateinit var bacteriaNormalTexture : Texture
    lateinit var bacteriaSpecularTexture : Texture


    private val wrappedAnchors = mutableListOf<com.google.ar.core.examples.kotlin.libraryscan.WrappedAnchor>()
        ...
        try {
            ...
            bacteriaShader =
                Shader.createFromAssets(
                    ...
                    .setTexture("u_AlbedoTexture", bacteriaAlbedoTexture)
                    .setTexture("u_RoughnessMetallicAmbientOcclusionTexture", bacteriaSpecularTexture)
                    //---default---//
            ...
            try {
                ...
                Log.d(TAG, "Bacteria mesh loaded successfully")
            } catch (e: IOException) {
                Log.e(TAG, "Failed to load bacteria model", e)
            }
...
//                    .setTexture("u_DfgTexture", dfgTexture)
            ...
            Log.e(HelloArRenderer.TAG, "Failed to read a required asset file", e)
    ...
    override fun onDrawFrame(render: SampleRender) {
        ...
        wrappedAnchors.filter { it.anchor.trackingState == TrackingState.TRACKING }) {
            ...
            bacteriaShader.setMat4("u_ModelView", modelViewMatrix)
            bacteriaShader.setMat4("u_ModelViewProjection", modelViewProjectionMatrix)
            val texture =
            ...
            bacteriaShader.setTexture("u_AlbedoTexture", texture)
            render.draw(bacteriaMesh, bacteriaShader, virtualSceneFramebuffer)
        }
    ...
    private fun updateLightEstimation(lightEstimate: LightEstimate, viewMatrix: FloatArray) {
        if (lightEstimate.state != LightEstimate.State.VALID) {
            bacteriaShader.setBool("u_LightEstimateIsValid", false)
            return
        }
        bacteriaShader.setBool("u_LightEstimateIsValid", true)
        Matrix.invertM(viewInverseMatrix, 0, viewMatrix, 0)
        bacteriaShader.setMat4("u_ViewInverse", viewInverseMatrix)
        updateMainLight(
    ...
    private fun updateMainLight(
        ...
        bacteriaShader.setVec4("u_ViewLightDirection", viewLightDirection)
        bacteriaShader.setVec3("u_LightIntensity", intensity)
    }
    ...
    private fun handleTap(frame: Frame, camera: Camera) {
        ...
        if (firstHitResult != null) {
            ...
            wrappedAnchors.add(
                com.google.ar.core.examples.kotlin.libraryscan.WrappedAnchor(
    ...
    private fun loadBacteriaMesh() {
        try {
            Log.d(TAG, "Loading bacteria mesh")
            bacteriaMesh = Mesh.createFromAsset(render, "models/bacteria.obj")
            Log.d(TAG, "Bacteria mesh loaded successfully")
        } catch (e: Exception) {
            Log.e(TAG, "Error loading bacteria mesh", e)
        }
    }
