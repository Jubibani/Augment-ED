...
class OrganismQuizQuestion : AppCompatActivity() {
    ...
    private val questionsList: ArrayList<OrganismQuestions> = Constants.getQuestions()
        ...
        btnSubmit?.setOnClickListener {
            if (!isAnswerChecked) {
                ...
                if (currentQuestionIndex < questionsList.size - 1) {
                    ...
                    val intent = Intent(this, OrganismQuizResult::class.java)
