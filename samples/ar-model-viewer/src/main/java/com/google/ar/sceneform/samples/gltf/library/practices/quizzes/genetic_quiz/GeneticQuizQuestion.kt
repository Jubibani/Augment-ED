...
class GeneticQuizQuestion : AppCompatActivity() {
    private var userName: String? = null

    private val questionsList: ArrayList<GeneticQuestions> = GeneticConstants.getQuestions()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userName = intent.getStringExtra(GeneticConstants.USER_NAME)
        ...
        btnSubmit?.setOnClickListener {
            if (!isAnswerChecked) {
                ...
                if (currentQuestionIndex < questionsList.size - 1) {
                    ...
                    intent.putExtra(GeneticConstants.USER_NAME, userName)
                    intent.putExtra(GeneticConstants.TOTAL_QUESTIONS, questionsList.size)
                    intent.putExtra(GeneticConstants.SCORE, totalScore)
                    startActivity(intent)
                    finish()
                }
