...
class GeneticQuizResult : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val userName = intent.getStringExtra(GeneticConstants.USER_NAME)
        val totalQuestions = intent.getIntExtra(GeneticConstants.TOTAL_QUESTIONS, 0)
        val score = intent.getIntExtra(GeneticConstants.SCORE, 0)
...
/*        btnRestart.setOnClickListener {
            val intent = Intent(this, GeneticQuizQuestion::class.java)
