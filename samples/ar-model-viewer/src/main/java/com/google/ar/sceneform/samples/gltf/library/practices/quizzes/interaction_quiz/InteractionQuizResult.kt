...
class InteractionQuizResult : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val userName = intent.getStringExtra(InteractionConstants.USER_NAME)
        val totalQuestions = intent.getIntExtra(InteractionConstants.TOTAL_QUESTIONS, 0)
        val score = intent.getIntExtra(InteractionConstants.SCORE, 0)
...
/*        btnRestart.setOnClickListener {
            val intent = Intent(this, InteractionQuizQuestion::class.java)
