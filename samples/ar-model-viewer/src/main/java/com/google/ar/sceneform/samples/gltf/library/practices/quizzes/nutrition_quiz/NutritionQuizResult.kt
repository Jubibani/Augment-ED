...
class NutritionQuizResult : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val userName = intent.getStringExtra(NutritionConstants.USER_NAME)
        val totalQuestions = intent.getIntExtra(NutritionConstants.TOTAL_QUESTIONS, 0)
        val score = intent.getIntExtra(NutritionConstants.SCORE, 0)
...
/*        btnRestart.setOnClickListener {
            val intent = Intent(this, NutritionQuizQuestion::class.java)
